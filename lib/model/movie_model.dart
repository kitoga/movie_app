...
class Data {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "movies":
            movies == null ? null : List<dynamic>.from(movies.map((x) => x.toJson())),
      };
}
...
class Movie {
  ...
  factory Movie.fromJson(Map<String, dynamic> json) => Movie(
        ...
        mpaRating:
            json["mpa_rating"] == null ? null : mpaRatingValues.map[json["mpa_rating"]],
        backgroundImage:
        ...
        smallCoverImage:
            json["small_cover_image"] == null ? null : json["small_cover_image"],
        mediumCoverImage:
            json["medium_cover_image"] == null ? null : json["medium_cover_image"],
        largeCoverImage:
            json["large_cover_image"] == null ? null : json["large_cover_image"],
        ...
        dateUploaded:
            json["date_uploaded"] == null ? null : DateTime.parse(json["date_uploaded"]),
        dateUploadedUnix:
            json["date_uploaded_unix"] == null ? null : json["date_uploaded_unix"],
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "mpa_rating": mpaRating == null ? null : mpaRatingValues.reverse[mpaRating],
        ...
        "torrents":
            torrents == null ? null : List<dynamic>.from(torrents.map((x) => x.toJson())),
...
enum MpaRating { PG, EMPTY }

final mpaRatingValues = EnumValues({"": MpaRating.EMPTY, "PG": MpaRating.PG});
...
class Meta {
  ...
  factory Meta.fromJson(Map<String, dynamic> json) => Meta(
        ...
        serverTimezone: json["server_timezone"] == null ? null : json["server_timezone"],
        apiVersion: json["api_version"] == null ? null : json["api_version"],
        executionTime: json["execution_time"] == null ? null : json["execution_time"],
      );
